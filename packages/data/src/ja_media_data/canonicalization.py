"""Compile accepted episode bindings into deterministic canonical inputs."""
...
from ja_media_data.pipeline_types import CanonicalEpisodeInput, CanonicalSubtitleInput
