...
def run_subsync_tui(
    *,
    ...
    srt_paths = resolve_srt_inputs(srt_inputs)
    tracks = []
    ...
    SubsyncTuiApp(source_path=source, tracks=tracks, initial_window_s=window_s).run()


def resolve_srt_inputs(inputs: list[str]) -> list[Path]:
    ...
    def render_candidates(self) -> Table:
        ...
        for index, track in enumerate(self.tracks):
            ...
            table.add_row(
                ...
                Text(track.path.name, style=candidate_style),
